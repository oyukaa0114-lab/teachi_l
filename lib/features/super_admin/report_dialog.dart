// report_dialog.dart
// Тайлан гаргах dialog - Жил/улирал сонгоод Excel тайлан үүсгэнэ
// Байрлал: lib/features/super_admin/report_dialog.dart
import 'package:flutter/material.dart';
import 'package:teachi_l/core/services/report_generator_service.dart';

class ReportDialog extends StatefulWidget {
  const ReportDialog({super.key});

  static Future<void> show(BuildContext context) {
    return showDialog(context: context, builder: (_) => const ReportDialog());
  }
...
class _ReportDialogState extends State<ReportDialog> {
  final _service = ReportGeneratorService();
